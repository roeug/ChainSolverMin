...
//     Encrypt:TTomEncryption;
  ...
  public
       ...
       characters).  }
   Function IsCellBlank(aCol:integer;aRow:Integer):Boolean;
...
Function TBKStringGrid.IsCellBlank(aCol:Integer;aRow:Integer):Boolean;
begin
...
function TBKStringGrid.SelectCell(aCol,aRow:Longint):Boolean;
var
	cellstring: string;
begin
...
procedure Register;
begin
  RegisterComponents('Additional',[TBKStringGrid]);
end;
